      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
        ...
        <section className="space-y-3 bg-[#161b22]/30 p-3 rounded-xl border border-[#30363d]/50">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xs font-bold text-[#c9d1d9] tracking-tight">Dead Code Detected</h3>
              <p className="text-[9px] text-[#8b949e] uppercase font-semibold">Unreachable methods & variables</p>
            </div>
            <span className="ml-auto text-[10px] font-bold bg-[#ff7b72]/10 text-[#ff7b72] px-2 py-0.5 rounded-full border border-[#ff7b72]/20">
        ...
        <section className="space-y-3 bg-[#161b22]/30 p-3 rounded-xl border border-[#30363d]/50">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xs font-bold text-[#c9d1d9] tracking-tight">God Objects</h3>
              <p className="text-[9px] text-[#8b949e] uppercase font-semibold">Overly complex components</p>
            </div>
          </div>
                ...
                <div className="p-3 flex items-start justify-between bg-gradient-to-br from-transparent to-[#d2a8ff]/5">
                  <div className="flex-1 min-w-0 pr-4">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="px-1.5 py-0.5 bg-[#30363d] text-[8px] font-bold text-[#8b949e] rounded uppercase">
                        {obj.type}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col items-end">
                    <span className="text-[8px] font-bold text-[#8b949e] uppercase tracking-tighter mb-0.5">Complexity</span>
                    <span className="text-xs font-black text-[#d2a8ff] tabular-nums">{obj.score}</span>
                  </div>
                </div>
        ...
        <section className="space-y-3 bg-[#161b22]/30 p-3 rounded-xl border border-[#30363d]/50">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-xs font-bold text-[#c9d1d9] tracking-tight">Architectural Cycles</h3>
              <p className="text-[9px] text-[#8b949e] uppercase font-semibold">Strongly coupled components</p>
            </div>
          </div>
              ...
              >
                ...
                <div className="mt-2.5 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-[8px] text-[#8b949e] font-bold uppercase tracking-widest">
                      Cycle {i + 1}
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-[9px] font-black text-[#ffa657] bg-[#ffa657]/10 px-1.5 py-0.5 rounded-full border border-[#ffa657]/20">
                      {cycle.length} NODES
                    </span>
                  </div>
                </div>
